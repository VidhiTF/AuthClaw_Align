      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,2.15fr)_minmax(18rem,.9fr)]">
        <div className="space-y-4">
          ...
          <section className="overflow-hidden rounded-md border border-[#DCE1E9] bg-white">
            <div className="flex items-center justify-between px-5 py-4"><div><h3 className="text-lg font-bold">Compliance readiness</h3><p className="text-xs text-[#6B7488]">Readiness requires qualified evidence. Activity record counts alone cannot establish compliance.</p></div><Link href="/compliance" className="text-xs font-semibold text-[#6D28D9]">View details →</Link></div>
