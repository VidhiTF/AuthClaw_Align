...
| CI execution | GitHub Actions workflow [`ci.yml`](../../.github/workflows/ci.yml) | Requires remote CI; attach the successful `AuthClaw Minimal Master CI` workflow URL and required-check result |
