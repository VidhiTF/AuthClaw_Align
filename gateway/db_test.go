...
func TestCompatibleDatabaseRevisions(t *testing.T) {
	tests := []struct {
		...
		{name: "default", want: []string{"053"}},
		{name: "rollout window", value: "052, 053", want: []string{"052", "053"}},
		{name: "duplicate", value: "053,053", wantErr: true},
		{name: "stale rollout", value: "051,052", wantErr: true},
