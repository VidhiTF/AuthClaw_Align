...
class OpenAIProvider(BaseProvider):
    def __init__(self, api_key: str = None, model_name: str = "gpt-4o", api_url: str = None, timeout: float = 30.0):
        ...
        if not self.api_key:
            raise ValueError("OpenAI provider credential is not configured.")
