...
This patch adds 214 positive net non-prose lines: template 2, SMTP service 16,
startup checks 3, onboarding 1, access-request service 13, review client 8,
migration 28, auth tests 37, access-request tests 102, migration tests 1, Compose
contract 3. Counts exclude the pre-existing DEBUG/template/Compose changes.
